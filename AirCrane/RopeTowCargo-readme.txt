...
# - Cargo can be simulated to be towed by rope.
...
############################### Example 1) Rope Tow Setup of AirCrane ################################
...
#Version 1.3 (Setup for Rope Tow)
#################################### Begin Cargo.nas ################################################
...
props.globals.initNode("ai/models/cargo/sim/hitches/aerotow/local-pos-z", -30, "DOUBLE" );
...
############################ End of Rope Tow instructions and additional file list #########################