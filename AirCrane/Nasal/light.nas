aircraft.light.new("/sim/model/aircrane/lighting/strobe", [0.015, 1.985]);
aircraft.light.new("/sim/model/aircrane/lighting/beaconfwd", [0.10, 0.90]);
aircraft.light.new("/sim/model/aircrane/lighting/beaconaft", [0.10, 0.90]);
